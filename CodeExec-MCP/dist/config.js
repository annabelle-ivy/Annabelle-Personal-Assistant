 ...
 */
export function isForbiddenPath(absolutePath) {
    const normalized = resolve(absolutePath);
    return FORBIDDEN_PREFIXES.some((prefix) => normalized === prefix || normalized.startsWith(prefix + '/'));
}
 ...
 */
export function getStrippedEnv() {
    const env = {};
