...
const NO_LEAK = { detected: false, toolName: '', parameters: {}, preamble: '' };
/**
 ...
 */
export function detectLeakedToolCall(text, availableTools) {
 ...
 */
export async function recoverLeakedToolCall(toolName, parameters, tools) {
...
//# sourceMappingURL=recover-tool-call.js.map