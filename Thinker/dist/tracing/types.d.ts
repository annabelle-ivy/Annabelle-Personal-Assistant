 ...
 */
export type TraceEvent = 'message_received' | 'context_loaded' | 'llm_call_start' | 'llm_call_complete' | 'tool_call_start' | 'tool_call_complete' | 'tool_call_error' | 'response_sent' | 'error' | 'complete';
/**
