 ...
 */
export async function loadExtractionPromptTemplate(filePath) {
 ...
 */
function buildExtractionPrompt(recentMessages, knownFacts, userIdentity) {
 ...
 */
export async function extractFactsFromConversation(model, recentMessages, knownFacts, confidenceThreshold = 0.7, userIdentity) {
